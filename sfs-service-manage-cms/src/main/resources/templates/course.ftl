...
<head>
    ...
    <title>从零开始--${courseBase.name}</title>
</head>
<!--
    课程详情页面模板
-->
...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.sfs.com/#/learning/${courseBase.id}/0"  target="_blank"  v-cloak>马上学习</a>
	    ...
	    <#if (coursePic.pic)??>
	     <p><img src="http://img.sfs.com/${coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
