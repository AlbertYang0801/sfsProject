...
[视频上传第一步-断点续传开发文档](https://gitee.com/zztiyjw/sfsProject/wikis/pages?sort_id=3482288&doc_id=1219120)

2. 文件处理
>由于页面流媒体播放协议选用了HLS协议，所以还需要将上传后的视频文件进行处理，将视频文件转换成m3u8格式的视频文件，实现视频的边下载边播放。

[视频上传第二步-文件处理开发文档](https://gitee.com/zztiyjw/sfsProject/wikis/pages?sort_id=3482289&doc_id=1219120)
